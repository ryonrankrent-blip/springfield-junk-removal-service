...
These fields are already established on the production site or in prior verification. Owner may approve reuse in citations without inventing new facts.

| Field | Verified value | Source | Notes |
|---|---|---|---|
| **Website URL** | https://springfieldjunkremovalservice.com | Production canonical | Live; 30 pages |
| **Domain** | springfieldjunkremovalservice.com | Production | Matches site |
| **Public CallRail phone (display)** | (417) 242-5370 | Site + live conversion test | Call path PASS |
| **Public CallRail phone (`tel:`)** | tel:4172425370 | All 30 pages | Consistent sitewide |
| **Primary service area** | Springfield, Missouri | Site copy + form `market` field | Verified |
| **County service area** | Greene County, Missouri | Site copy + city pages | Verified |
...
Use only services already represented on the site. Final subset may vary by platform field limits.
...
- House cleanout
- Estate cleanout
- Apartment / eviction cleanout
- Commercial junk removal
- Construction debris removal
- Yard waste removal
- Trash removal
- Mattress / couch removal
- Hot tub removal
- Shed removal
...
## 3. Operational facts not yet established

**These must not be invented or published.** Citation profiles must not imply facts below until verified.
...
| Employees, crews, trucks | **Not established** | Do not claim team size, fleet, or on-staff haulers |
| Years in business | **Not established** | Do not claim tenure |
| Locally owned / family-owned | **Not established** | Do not claim ownership type |
| Public street address / storefront | **Not established** | Do not invent; do not imply physical storefront |
| Real customer reviews / ratings | **None** | Do not import or fabricate review counts |

---

## 4. Platform-by-platform identity requirements

Tier A platforms only. Duplicate inspection complete; no existing listings found. **Identity approval does not authorize creation.**

### Bing Places

| Item | Detail |
|---|---|
| **Fields required for creation** | Business name; phone; website; category; service area or address; description |
| **Fields optional** | Secondary categories; photos; social links; hours |
| **Verification likely required** | Yes — postcard, phone, or email |
| **Address requirements** | Physical address required for verification; **HideAddress** supported for businesses without public storefront |
| **Service-area compatibility** | Strong — designed for businesses that travel to customers |
| **Operator requirement** | Real business behind listing; representative must control phone |
| **Current risk** | Low duplicate risk; **medium policy risk** without verified operator and private address |
| **Recommendation after identity review** | **Approve for creation review** — first candidate — only after operator + private address strategy confirmed |
...
| Item | Detail |
|---|---|
| **Fields required for creation** | Business name; phone; category; service area or address |
| **Fields optional** | Website; hours; photos; amenities; service offerings |
| **Verification likely required** | Yes — phone or email |
| **Address requirements** | Mobile / service-area business supported; address can be hidden; up to 6 service-area cities |
| **Service-area compatibility** | Strong for junk removal category |
| **Operator requirement** | Moderate — Yelp moderates lead-gen and suspicious profiles |
| **Current risk** | Low duplicate risk; **medium moderation risk** under current model |
| **Recommendation after identity review** | **Approve for creation review** — third candidate — after identity packet approved |

### Facebook Page

| Item | Detail |
|---|---|
| **Fields required for creation** | Page name; category; contact method (phone and/or website) |
| **Fields optional** | Service area or address (not both); hours; about text; photos |
| **Verification likely required** | Meta account; possible business verification for ads/features |
| **Address requirements** | Service area **or** address — not both; service-area model fits if owner approves |
...
| Item | Detail |
|---|---|
| **Fields required for creation** | Business name; category; address (for verification); service description |
| **Fields optional** | Website; phone; photos; offers |
| **Verification likely required** | Yes — business documentation for posts; address verification |
| **Address requirements** | Address required for verification; **can hide from public page** |
...
| Item | Detail |
|---|---|
| **Fields required for creation** | Business name; category; phone; website; address (real; can hide street publicly) |
| **Fields optional** | Email; description; images; keywords |
| **Verification likely required** | Yes — email / claim |
| **Address requirements** | Real address required; street can be hidden in privacy settings |
| **Service-area compatibility** | Good — local directory with hide-address option |
| **Operator requirement** | Moderate — needs legitimate address for backend verification |
| **Current risk** | Low duplicate risk; **medium operational risk** without private address |
| **Recommendation after identity review** | **Approve for creation review** — sixth candidate — after operator + private address confirmed |
...
- Name, phone, and website must match across all approved citations exactly.
- Do not add alternate phones, domains, or name variants.
- Do not publish a public street address unless owner approves a verified workflow with hide-address support.
- Descriptions must remain claim-safe: request intake and confirmation language, not direct hauling guarantees.
...
### Platform readiness after identity review
