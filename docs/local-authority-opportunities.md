...
## Municipal & county disposal resources

| Source | Official URL | Link opportunity | Content idea | Outreach required | Risk | Approval |
|---|---|---|---|---|---|---|
| City of Springfield — Solid Waste Management | https://www.springfieldmo.gov/2331/Solid-Waste-Management-Recycling | Outbound cite in guides | "Where Springfield residents can recycle, drop off yard waste, and dispose of bulky items" | No — cite only | **Low** | Content edit |
| Waste Wizard (City tool) | https://www.springfieldmo.gov/5532/Waste-Wizard | Interactive reference + outbound link | Item-by-item disposal lookup page section | No | **Low** | Content edit |
...
## Donation, reuse & community resources

| Source | Type | Link opportunity | Content idea | Outreach | Risk | Approval |
|---|---|---|---|---|---|---|
| City Recycling & Donation Locations Guide | Official PDF | Primary outbound | "Donate before you dump" section on cleanout guides | No | **Low** | Content edit |
| Habitat ReStore (Springfield area) | Nonprofit retail | Outbound cite | Furniture/appliance donation alternative | No | **Low** | Verify URL |
| Victory Mission mattress program | Contractor via city | Outbound cite | Mattress recycling path (city contract) | No | **Low** | Content edit |
| Goodwill / Salvation Army Springfield | Thrift | Outbound cite | Soft goods and small furniture donation | No | **Low** | Verify locations |

---

## Content authority opportunities (no outreach)

| Opportunity | Target pages | GSC rationale |
|---|---|---|
| Springfield disposal rules explainer | New guide or expand `what-items-can-be-removed` | Supports informational intent; differentiates from competitors |
| Construction debris + landfill bans | `construction-debris-removal-springfield-mo` | GSC avg position ~5.9 — strengthen with local rules |
...
## Outreach-required opportunities (defer)

| Opportunity | Type | Risk | Approval |
|---|---|---|---|
| Springfield Area Chamber content partnership | Membership / event sponsorship | Medium — spend | **Required** |
| Local property-management associations | Resource link exchange | Medium | **Required** |
| Greene County contractor associations | Directory / resource page | Medium | **Required** |
| Local news / community sponsorship | Paid or earned media | Medium–High | **Required** |
| University / college move-out guides | Seasonal resource page | Low–Medium | **Required** |

---

## Linkable asset ideas (create on-site first)

| Asset | Format | Reuse across cities |
|---|---|---|
| Springfield bulky item disposal checklist | On-site guide + PDF | **Yes** — template per market |
| Move-out junk room-by-room checklist | Guide page | **Yes** |
| "Donate vs haul away" decision tree | Guide section | **Yes** with local sources swapped |
| Construction debris ban quick-reference | Section on debris page | **Yes** with local rules |
| Apartment turnover cleanout timeline | Eviction/apartment pages | **Yes** |
...
| Risk | Mitigation |
|---|---|
| Outdated city URLs | Reverify links before any content edit |
| Implying city endorsement | Use "official resource" language — no partnership claims |
| Hazmat overreach | Keep hoarder/specialty disclaimers; link to HCCC for chemicals |
| Copyright on PDFs | Link to official city documents; do not republish full PDFs |
